...
|---|---|---|---|---|---|
| DAT_05 | Downloaded Garmin public `Activity.fit` sample. | At least one public GPS-bearing FIT activity file is staged. | `Activity.fit` from Garmin `fit-javascript-sdk` was staged with SHA-256 recorded. | PASS | `assets/DAT_03-source-manifest.txt` |
