...
|---|---|---|---|---|---|
| DAT_04 | Used the five suggested `gps-touring/sample-gpx` raw GPX files. | Suggested verified GPX source is used or an equivalent public source is recorded. | All five staged GPX files are from the suggested `gps-touring/sample-gpx` repository. | PASS | `assets/DAT_03-source-manifest.txt` |
