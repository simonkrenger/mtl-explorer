...
SELECT 10000000 + g, 'MEDIA', 'med28-' || g || '.jpg', 'med28',
       '/synthetic/med28', '/synthetic/med28/med28-' || g || '.jpg', 1024,
       clock_timestamp(), clock_timestamp(), clock_timestamp(), 1,
       'COMPLETED_WITH_SUCCESS', 'MED_28'
...
INSERT INTO indexed_file
  (id, "index", name, path, base_path, full_path, size, create_date,
   index_added_date, index_update_date, version, indexer_status, indexer_id)
SELECT 20000000 + g, 'GPS', 'med28-track-' || g || '.gpx', 'med28',
       '/synthetic/med28', '/synthetic/med28/med28-track-' || g || '.gpx', 1024,
       clock_timestamp(), clock_timestamp(), clock_timestamp(), 1,
       'COMPLETED_WITH_SUCCESS', 'MED_28'
